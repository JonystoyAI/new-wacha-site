      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between border-b-2 border-zinc-800 pb-4 mb-10 gap-4">
          ...
          <p className="font-jetbrains text-xs text-zinc-400 max-w-md">
            Plataformas web de alta conversión, inteligencia artificial conversacional, finanzas AEO y arquitectura visual brutalista.
          </p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative aspect-video bg-black border border-zinc-800 overflow-hidden group/img">
                    <img
                      ...
                      loading="lazy"
                      onError={(e) => {
                        // Fallback image if custom image file not directly present
